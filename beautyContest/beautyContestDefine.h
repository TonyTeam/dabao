...
#define ALBUMNAME @"DaBaoDocument"
...
#define EMPTYSTRING @"     : "
//默认橙色的RGB
#define APPDEFAULTORANGE ([UIColor colorWithRed:56.0 / 255.0 green:133.0 / 255.0 blue:254.0 / 255.0 alpha:1.0])
//默认标题颜色
