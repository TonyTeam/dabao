...
- (void)setupNavigationBar {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"相冊" style:(UIBarButtonItemStyleDone) target:self action:@selector(rightBarButtonItenAction)];
}
...
- (void)readImageFromAlbum {
    ...
    if (device) {
        ...
        if (status == PHAuthorizationStatusNotDetermined) { // 用户还没有做出选择
            ...
            UIAlertController *alertC = [UIAlertController alertControllerWithTitle:@"⚠️ 警告" message:@"請去-> [設置 - 隱私 - 圖片 - 大寶] 打開訪問開關" preferredStyle:(UIAlertControllerStyleAlert)];
            ...
            UIAlertController *alertC = [UIAlertController alertControllerWithTitle:@"溫馨提示" message:@"由於系統原因, 無法訪問相冊" preferredStyle:(UIAlertControllerStyleAlert)];
            UIAlertAction *alertA = [UIAlertAction actionWithTitle:@"確定" style:(UIAlertActionStyleDefault) handler:^(UIAlertAction * _Nonnull action) {
